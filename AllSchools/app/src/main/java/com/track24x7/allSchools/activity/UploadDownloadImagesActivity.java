...
import com.track24x7.allSchools.service.MyDownloadService;
import com.track24x7.allSchools.service.MyUploadService;
import com.track24x7.allSchools.util.Upload;

import java.util.ArrayList;
import java.util.List;
import java.util.Locale;

public class UploadDownloadImagesActivity extends BaseMenuActivity {
    private static final String TAG = "Storage#MainActivity";

    private static final int RC_TAKE_PICTURE = 101;

    private static final String KEY_FILE_URI = "key_file_uri";
    private static final String KEY_DOWNLOAD_URL = "uploads/";
...
// Local broadcast receiver
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                switch (intent.getAction()) {
                    case MyDownloadService.DOWNLOAD_COMPLETED:
                        ...
                        // Alert success
                        showMessageDialog("Download sucsess", String.format(Locale.getDefault(),
        ...
        recyclerView = (RecyclerView) findViewById(R.id.thumbNails_recyclerView);
        ...
        progressDialog.show();
       // mDatabase = FirebaseDatabase.getInstance().getReference(WebServicesUrls.DATABASE_PATH_UPLOADS);
...
/*        mDatabase.addValueEventListener(new ValueEventListener() {
    ...
    private void beginDownload() {
        ...
        // Show loading spinner
        //showProgressDialog("Downloading, please wait...");
    }
